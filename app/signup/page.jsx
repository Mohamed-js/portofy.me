...
const SignUP = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (dataToSend.password !== dataToSend.confirm_password) {
      return toast.error("Password and Password Confirmation don't match!");
    }
      ...
      <form className="max-w-md mx-auto w-full" onSubmit={handleSubmit}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            Employment (Ex. Freelancer, Microsoft, Google)
          </label>
        </div>
        <button
          type="submit"
          className="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-black dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Sign Up
        </button>
      </form>{" "}
