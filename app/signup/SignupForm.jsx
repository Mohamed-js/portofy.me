...
export default function SignupForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    lastName: "",
    phone: "",
    plan: "free", // Always Free at signup
  });
    ...
    <div className="w-full max-w-md p-4 mx-4 bg-white/10 backdrop-blur-md rounded-lg shadow-lg border border-white/20">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-bl from-[#e45053] to-[#fd9c46] rounded-md hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-orange-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all duration-200"
        >
          {loading ? (
            <>
              <svg
