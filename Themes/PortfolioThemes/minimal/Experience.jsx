...
const Experience = ({ portfolio }) => {
  ...
  return (
    <div className="container py-16 md:py-20 md:pt-0 mx-auto" id="work">
          ...
          <div key={index} className="mt-8 flex flex-col md:flex-row md:gap-8">
            <div className="md:w-2/5">
              <div className="flex justify-start ml-2">
                <p className="font-header text-xl font-bold text-[#3f51b5]">
                  {exp.company}
                </p>
              </div>
            </div>
            ...
            <div className="md:w-3/5">
              <div className="relative flex">
                ...
                <div className="mt-1 flex">
                  <span className="absolute left-8 top-1 hidden h-4 w-4 rounded-full border-2 bg-white text-gray-200 md:block"></span>
                  <div className="md:-mt-1 md:pl-8 ml-2">
                    <span className="block font-body font-semibold text-gray-400">
                    ...
                    <span className="block pt-2 font-header text-xl font-bold uppercase text-[#3f51b5]">
                      {exp.role}
                    </span>

                    <ul className="list-disc list-inside pt-2 font-body text-black">
